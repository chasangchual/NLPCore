...
public class TestCorpusProvider {
    // do not change any test data in the class.
    // even if you need a simillar string with tiny changes, you should create a new variable and getter.
    private static String nytimesArticle = "HONG KONG — China is undertaking a diplomatic and public relations blitz to rally support for its sweeping maritime claims in the South China Sea ahead of a decision by an international court that may rule against Beijing.\n" +
    ...
    private static String stopWords = "but be with such then for no will not are and their if this on into a or there in that they was is it an the as at these by to of";

    private static String stackOverflowSentence = "You could create a custom serializer for serializing Foo objects. Then in your custom FooSerializer implementation, you could check for a null bar value and serialize it as a default Bar instance.";

    public static String getNYTimesArticle() {
        return nytimesArticle;
    }

    public static String getAllStopwordString() {
        return stopWords;
    }

    public static String getStackOverflowSentence() {
        return stackOverflowSentence;
    }
}
